...
class AppGetDetectionsLoadingState extends AppStates {}

class AppGetDetectionsSuccessState extends AppStates {}

class AppGetDetectionsErrorState extends AppStates {
  final String error;
  AppGetDetectionsErrorState(this.error);
}

class AppGetAllDetectionsLoadingState extends AppStates {}

class AppGetAllDetectionsSuccessState extends AppStates {}

class AppGetAllDetectionsErrorState extends AppStates {
  final String error;
  AppGetAllDetectionsErrorState(this.error);
}
